...
function BoardForm() {
  ...
  const updateColumnName = (e, x) => {
    let Newcolumns = Newboard.columns.map((column) =>
      column.id == x ? { ...column, name: e.target.value } : column
    );
  ...
  return (
    ...
    >
      <form action="#" className="boardform" onSubmit={insertNewBoard}>
        ...
        <div className="group">
          <label htmlFor="Name">
            Name {validation && <span className="validation">*Required </span>}
          </label>
          <input
            type="text"
            disabled={order == "create" || order == "edit" ? false : true}
            value={Newboard.name}
            onChange={(e) => {
        ...
        <div className="group">
          ...
          {Newboard.columns.map((column, index) => {
            return (
              <div className="input-columns" key={column.id}>
                ...
                <input
                  ...
                  type="text"
                  onChange={(e) => {
                    updateColumnName(e, column.id);
                  }}
                  value={column.name}
                  placeholder={
                    columnvalidate == column.id
        ...
        <div className="group">
          ...
          <button type="submit" className="savebutton">
            {order == "create" ? "Create New Board" : "Save Changes"}
          </button>
        </div>
      </form>
    </div>
